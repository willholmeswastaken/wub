    ...
    return (
        <div className="flex flex-col space-y-10 pb-10">
            ...
            <section className="h-full flex-1 mx-auto max-w-4xl w-full flex flex-col space-y-3">
                ...
                <div className="bg-white border border-gray-200 p-5 sm:border-gray-100 sm:p-10 sm:shadow-lg sm:rounded-lg flex flex-col gap-y-2">
                            ...
                            Object.entries(links.countryClicks).map(([country, clicks]) => (
                                <div key={country} className="flex justify-between items-start">
                                    <div className="flex flex-row items-start leading-3 space-x-2">
                                        {country !== 'unknown' && <Image alt={country} unoptimized src={`https://flag.vercel.app/m/${country}.svg`} className="h-3 w-5" width={20} height={12} />}
